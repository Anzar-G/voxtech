      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 text-white rounded-3xl p-6 lg:p-10 shadow-2xl h-full">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-3 lg:gap-6 mb-12">
              {certificates.map((cert, index) => (
                <div
                  key={index}
                  className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 lg:p-8 border border-white/20 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center"
                >
                  ...
                  <p className="text-[10px] lg:text-sm text-white/60 mb-0.5 lg:mb-1">{cert.issuer}</p>
                  <p className="text-[10px] lg:text-sm text-white/60 mb-3 lg:mb-4">{cert.year}</p>
                  <a
                    href={cert.link}
                    target="_blank"
